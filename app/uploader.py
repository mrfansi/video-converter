...
class CloudflareR2Uploader:
    ...
    def __init__(self):
        ...
        if not all([self.endpoint_url, self.access_key_id, self.secret_access_key]):
            logger.warning("Missing R2 credentials. Upload functionality will not work.")
    ...
    def upload_file(self, file_path: str, content_type: str = 'application/json', custom_key: str = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if self.custom_url:
                ...
                try:
                    ...
                    logger.info(f"Generated pre-signed URL with 1 week expiration (maximum allowed)")
                    ...
                    logger.info(f"Using Cloudflare R2 public download URL format: {url}")
