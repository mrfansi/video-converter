...
class TaskResult:
    ...
    @classmethod
    def success_result(cls, task_id: Union[str, UUID], metadata: Optional[Dict[str, Any]] = None) -> 'TaskResult':
    ...
    @classmethod
    def error_result(cls, error: str, metadata: Optional[Dict[str, Any]] = None) -> 'TaskResult':
...
class ITaskQueue(ABC):
    ...
    @abstractmethod
    def get_tasks(self, status: Optional[TaskStatus] = None, limit: int = 10) -> List[ITask]:
