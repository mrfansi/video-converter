...
class StorageResult:
    ...
    @classmethod
    def success_result(cls, key: str, url: str, metadata: Optional[Dict[str, Any]] = None) -> 'StorageResult':
    ...
    @classmethod
    def error_result(cls, error: str, metadata: Optional[Dict[str, Any]] = None) -> 'StorageResult':
...
class IStorage(ABC):
    ...
    @abstractmethod
    def upload(self, file_path: str, content_type: str, custom_key: Optional[str] = None) -> StorageResult:
    ...
    @abstractmethod
    def upload_stream(self, file_stream: BinaryIO, content_type: str, custom_key: str) -> StorageResult:
