...
from app.models.video_params import FrameExtractionParams, FrameExtractionParamBuilder, FrameExtractionMethod

logger = logging.getLogger(__name__)


def extract_frames(video_path: str, output_dir: str, fps: int = 24, width: Optional[int] = None, height: Optional[int] = None) -> List[str]:
    """
    ...
    try:
        ...
        params = (FrameExtractionParamBuilder()
