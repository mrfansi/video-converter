...
class VideoProcessor:
    ...
    def get_strategy(
        self, strategy_type: Union[VideoProcessingStrategy, str]
        ...
        if isinstance(strategy_type, str):
            try:
                ...
                logger.warning(
                    f"Invalid strategy type: {strategy_type}. Using STANDARD instead."
                )
                strategy_type = VideoProcessingStrategy.STANDARD

        return self.strategies.get(
            strategy_type, self.strategies[VideoProcessingStrategy.STANDARD]
        )
