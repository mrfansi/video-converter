...
from app.models.lottie_params import VideoProcessingStrategy
    ...
    def process_video(self, file_path: str, output_dir: str, temp_dir: str,
        ...
        try:
            ...
            if self.frame_processor is None:
                from app.infrastructure.video_processing.component_strategies import StandardFrameProcessor
            ...
            if self.lottie_generator is None:
                from app.infrastructure.video_processing.component_strategies import StandardLottieGenerator
            ...
            if self.thumbnail_generator is None:
                from app.infrastructure.video_processing.component_strategies import StandardThumbnailGenerator
