        ...
        try:
            ...
            for i, frame_path in enumerate(frame_paths):
                ...
                if progress_callback:
                    ...
                    progress_callback(
                        progress, f"Processing frame {i+1}/{total_frames}"
                    )
        ...
        try:
            ...
            for i, frame_path in enumerate(frame_paths):
                ...
                if progress_callback:
                    ...
                    progress_callback(
                        progress,
                        f"Processing frame {i+1}/{total_frames} (high quality)",
                    )
            ...
            if progress_callback:
                progress_callback(
                    100, f"Processed {len(svg_paths)} frames to SVG (high quality)"
                )
        ...
        try:
            ...
            for i, frame_path in enumerate(frame_paths):
                ...
                if progress_callback:
                    ...
                    progress_callback(
                        progress,
                        f"Processing frame {i+1}/{len(frame_paths)} (fast mode)",
                    )
            ...
            if progress_callback:
                progress_callback(
                    100, f"Processed {len(svg_paths)} frames to SVG (fast mode)"
                )
        ...
        try:
            ...
            params = (
                ...
                .with_optimization_level(
                    LottieOptimizationLevel.MEDIUM
                    if optimize
                    else LottieOptimizationLevel.NONE
                )
                .build()
            )
