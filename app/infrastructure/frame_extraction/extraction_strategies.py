        ...
        try:
            ...
            for i in range(num_frames):
                ...
                if target_width != original_width or target_height != original_height:
                    frame = self.frame_resizer.resize_frame(frame, target_width, target_height)
...
class HybridExtractionStrategy(BaseFrameExtractionStrategy):
    ...
    def extract_frames(self, video_path: str, output_dir: str, fps: int = 24, 
        ...
        try:
            ...
            return self.ffmpeg_strategy.extract_frames(video_path, output_dir, fps, width, height)
            
        except Exception as e:
            # If FFmpeg fails, try OpenCV
            logger.warning(f"FFmpeg extraction failed: {str(e)}. Falling back to OpenCV.")
            ...
            try:
                # Try OpenCV
                return self.opencv_strategy.extract_frames(video_path, output_dir, fps, width, height)
