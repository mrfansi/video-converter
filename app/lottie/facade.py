...
class LottieGeneratorFacade:
    ...
    def convert_video_frames_to_lottie(self,
                                       png_frames: List[str],
                                       output_dir: str,
                                       output_path: str,
                                       fps: int = 30,
        ...
        try:
            ...
            logger.info(f"Successfully converted PNG frames to Lottie animation: {output_file}")
            return output_file
    ...
    def trace_png_to_svg(self, png_path: str, output_dir: str, simplify_tolerance: float = 1.0) -> str:
        ...
        """
        return self.image_processor.trace_png_to_svg(png_path, output_dir, simplify_tolerance)
    
    def create_lottie_from_svgs(self,
                               svg_paths: List[str],
                               output_path: str,
                               fps: int = 30,
                               width: Optional[int] = None,
        ...
        try:
            ...
            return self.lottie_generator.save_lottie_json(lottie_json, output_path, compress)
