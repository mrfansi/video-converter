...
class TestImageProcessor(BaseTest):
    ...
    def mock_cv2(self):
        ...
        with patch("app.lottie.image_processor.cv2") as mock:
            ...
            mock.findContours.return_value = (
    ...
    def test_trace_png_to_svg_basic(
        self,
        temp_output_dir,
        mock_cv2,
        mock_simplify_contours,
        mock_contours_to_svg_paths,
    ):
    ...
    def test_trace_png_to_svg_with_threshold(
        self,
        temp_output_dir,
        mock_cv2,
        mock_simplify_contours,
    ...
    def test_trace_png_to_svg_with_simplify(
        self,
        temp_output_dir,
        mock_cv2,
        mock_simplify_contours,
        ...
        result = trace_png_to_svg(
            str(test_png), str(output_path), simplify=True, simplify_tolerance=2.0
        )
    ...
    def test_trace_png_to_svg_with_min_contour_area(
        self,
        temp_output_dir,
        mock_cv2,
        mock_simplify_contours,
        ...
        result = trace_png_to_svg(str(test_png), str(output_path), min_contour_area=100)
