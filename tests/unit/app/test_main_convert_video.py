...
class TestConvertVideoFormatTask(BaseTest):
    ...
    def test_convert_video_format_task_basic(self, mock_task_queue, mock_video_converter, 
                                           mock_uploader, mock_utils, mock_os):
    ...
    def test_convert_video_format_task_with_different_formats(self, mock_task_queue, mock_video_converter, 
                                                           mock_uploader, mock_utils, mock_os):
    ...
    def test_convert_video_format_task_error_handling(self, mock_task_queue, mock_video_converter, 
                                                   mock_utils, mock_os):
    ...
    def test_convert_video_format_task_invalid_input(self, mock_task_queue, mock_video_converter, 
                                                  mock_utils, mock_os):
    ...
    def test_convert_video_format_task_progress_tracking(self, mock_task_queue, mock_video_converter, 
                                                      mock_uploader, mock_utils, mock_os):
        ...
        mock_task_queue.return_value.update_task_progress.assert_called_with("test-task-id", 25)
        
        progress_callback(50)
        mock_task_queue.return_value.update_task_progress.assert_called_with("test-task-id", 50)
        
        progress_callback(100)
        mock_task_queue.return_value.update_task_progress.assert_called_with("test-task-id", 100)
