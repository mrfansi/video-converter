...
class TestUtils(BaseTest):
    ...
    def test_extract_frames_basic(self, temp_output_dir, mock_cv2, mock_os):
        ...
        # Call the function
        result = extract_frames(str(test_video), str(temp_output_dir), frame_rate=1)
    ...
    def test_extract_frames_with_custom_prefix(
        self, temp_output_dir, mock_cv2, mock_os
    ):
    ...
    def test_extract_frames_with_max_frames(self, temp_output_dir, mock_cv2, mock_os):
        ...
        result = extract_frames(
            str(test_video), str(temp_output_dir), frame_rate=1, max_frames=2
        )
    ...
    def test_extract_frames_with_resize(self, temp_output_dir, mock_cv2, mock_os):
        ...
        result = extract_frames(
            str(test_video), str(temp_output_dir), frame_rate=1, resize=(320, 240)
        )
    ...
    def test_extract_frames_with_output_format(
        self, temp_output_dir, mock_cv2, mock_os
    ):
        ...
        result = extract_frames(
            str(test_video), str(temp_output_dir), frame_rate=1, output_format="jpg"
        )
