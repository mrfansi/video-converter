...
class TestProcessVideoTask(BaseTest):
    ...
    def test_process_video_task_lottie(
        self,
        mock_task_queue,
        mock_downloader,
        mock_utils,
    ...
    def test_process_video_task_video_format(
        self, mock_task_queue, mock_downloader, mock_utils, mock_uploader, mock_os
    ):
    ...
    def test_process_video_task_error_handling(
        self, mock_task_queue, mock_downloader, mock_utils, mock_os
    ):
    ...
    def test_process_video_task_invalid_format(
        self, mock_task_queue, mock_downloader, mock_utils, mock_os
    ):
    ...
    def test_process_video_task_progress_tracking(
        self,
        mock_task_queue,
        mock_downloader,
        mock_utils,
