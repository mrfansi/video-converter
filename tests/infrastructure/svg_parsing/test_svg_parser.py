...
class TestSVGParserProcessor(unittest.TestCase):
    ...
    def test_parse_svg_to_paths_optimized_strategy(self, mock_svg):
        ...
        self.parser.optimized_strategy = OptimizedSVGPathParsingStrategy(5.0)
    ...
    def test_parse_svg_to_paths_simplified_strategy(self, mock_svg):
        ...
        # Create params
        params = SVGParsingParams(svg_path=self.test_svg_path, strategy="simplified")
    ...
    def test_parse_svg_to_paths_fallback_strategy(self, mock_svg):
        ...
        # Create params
        params = SVGParsingParams(svg_path=self.test_svg_path, strategy="fallback")
    ...
    def test_parse_svg_to_paths_error_handling_raise(self, mock_svg):
        ...
        params = SVGParsingParams(
            svg_path=self.test_svg_path, strategy="standard", error_handling="raise"
        )
    ...
    def test_parse_svg_to_paths_error_handling_log(self, mock_svg):
        ...
        params = SVGParsingParams(
            svg_path=self.test_svg_path, strategy="standard", error_handling="log"
        )
    ...
    def test_parse_svg_paths_to_lottie_format(self, mock_svg):
        ...
        # Create params
        params = SVGParsingParams(
            svg_path=self.test_svg_path,  # Will be used for each SVG path
            strategy="standard",
        )

        # Call the method
        result = self.parser.parse_svg_paths_to_lottie_format(
            [self.test_svg_path, self.test_svg_path], params
        )
