...
class TestVideoFormatTaskProcessor:
    ...
    def test_standard_strategy(self, mock_convert_video, mock_get_video_info, 
                              mock_progress_tracker, mock_cloud_uploader, 
                              mock_video_info, mock_conversion_result):
        ...
        assert mock_cloud_uploader.uploads[0]["file_path"] == mock_conversion_result["output_path"]
    
    @patch("app.video_converter.get_video_info")
    @patch("app.video_converter.convert_video")
    def test_optimized_strategy(self, mock_convert_video, mock_get_video_info, 
                               mock_progress_tracker, mock_cloud_uploader, 
                               mock_video_info, mock_conversion_result):
    ...
    @patch("app.video_converter.convert_video")
    def test_fallback_strategy(self, mock_convert_video, 
                              mock_progress_tracker, mock_cloud_uploader, 
    ...
    @patch("app.video_converter.get_video_info")
    @patch("app.video_converter.convert_video")
    def test_strategy_selection(self, mock_convert_video, mock_get_video_info, 
                               mock_progress_tracker, mock_cloud_uploader, 
                               mock_video_info, mock_conversion_result):
    ...
    @patch("app.video_converter.get_video_info")
    @patch("app.video_converter.convert_video")
    def test_with_parameter_builder(self, mock_convert_video, mock_get_video_info, 
                                   mock_progress_tracker, mock_cloud_uploader, 
                                   mock_video_info, mock_conversion_result):
    ...
    @patch("app.video_converter.get_video_info")
    @patch("app.video_converter.convert_video")
    def test_error_handling(self, mock_convert_video, mock_get_video_info, 
                           mock_progress_tracker, mock_cloud_uploader):
