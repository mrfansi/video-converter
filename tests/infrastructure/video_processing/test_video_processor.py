...
from app.models.lottie_params import VideoProcessingParams, VideoProcessingParamBuilder, VideoProcessingStrategy
...
class TestVideoProcessor:
    ...
    def test_params(self):
        ...
        return VideoProcessingParamBuilder()\
    ...
    @patch('app.infrastructure.video_processing.processing_strategies.StandardVideoProcessingStrategy.process_video')
    def test_process_video_standard(self, mock_process_video, mock_cloud_uploader, test_params):
    ...
    @patch('app.infrastructure.video_processing.high_quality_strategy.HighQualityVideoProcessingStrategy.process_video')
    ...
    @patch('app.infrastructure.video_processing.fast_strategy.FastVideoProcessingStrategy.process_video')
