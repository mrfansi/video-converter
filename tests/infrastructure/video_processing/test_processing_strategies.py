...
from app.infrastructure.video_processing.processing_strategies import (
    StandardVideoProcessingStrategy,
)
from app.infrastructure.video_processing.high_quality_strategy import (
    HighQualityVideoProcessingStrategy,
)
from app.infrastructure.video_processing.fast_strategy import (
    FastVideoProcessingStrategy,
)
...
class TestStandardVideoProcessingStrategy:
    ...
    def test_process_video(
        self,
        mock_extract_frames,
        mock_frame_processor,
        mock_lottie_generator,
...
class TestHighQualityVideoProcessingStrategy:
    ...
    @patch("app.infrastructure.frame_extractor.FrameExtractor.extract_frames")
    @patch(
        "app.infrastructure.video_processing.component_strategies.HighQualityFrameProcessor.process_frames"
    )
    @patch(
        "app.infrastructure.video_processing.component_strategies.StandardLottieGenerator.generate_lottie"
    )
    @patch(
        "app.infrastructure.video_processing.component_strategies.StandardThumbnailGenerator.generate_thumbnail"
    )
    def test_process_video(
        self,
        mock_generate_thumbnail,
        mock_generate_lottie,
        mock_process_frames,
        mock_extract_frames,
    ):
        """Test the process_video method."""
...
class TestFastVideoProcessingStrategy:
    ...
    @patch("app.infrastructure.frame_extractor.FrameExtractor.extract_frames")
    @patch(
        "app.infrastructure.video_processing.component_strategies.FastFrameProcessor.process_frames"
    )
    @patch(
        "app.infrastructure.video_processing.component_strategies.StandardLottieGenerator.generate_lottie"
    )
