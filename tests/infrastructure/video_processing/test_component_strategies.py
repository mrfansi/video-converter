...
class TestFrameProcessors:
    ...
    @patch('app.lottie.image_processor_refactored.RefactoredImageProcessor.trace_png_to_svg')
    def test_standard_frame_processor(self, mock_trace_png_to_svg, mock_frame_paths, mock_output_dir):
    ...
    @patch('app.lottie.image_processor_refactored.RefactoredImageProcessor.trace_png_to_svg')
    def test_high_quality_frame_processor(self, mock_trace_png_to_svg, mock_frame_paths, mock_output_dir):
    ...
    @patch('app.lottie.image_processor_refactored.RefactoredImageProcessor.trace_png_to_svg')
    def test_fast_frame_processor(self, mock_trace_png_to_svg, mock_frame_paths, mock_output_dir):
        ...
        for call_args in mock_trace_png_to_svg.call_args_list:
            ...
            assert params.simplify_tolerance == 2.0  # Higher tolerance for less detail but faster processing
...
class TestLottieGenerator:
    ...
    def test_standard_lottie_generator(self, mock_generate_lottie, mock_svg_paths, mock_output_path):
...
class TestThumbnailGenerator:
    ...
    @patch('cv2.resize')
    @patch('cv2.imwrite')
    def test_standard_thumbnail_generator(self, mock_imwrite, mock_resize, mock_imread, mock_frame_path, mock_output_dir):
